...
1. **Commit cadence:** "Should I include a commit step after each task stage, or do you prefer to commit manually?"
...
- If commits per stage: include `git add` + `git commit` steps at the end of every task
- If no commits: omit commit steps from tasks
